...
async fn main() {
    ...
    let admin_routes = Router::new()
        ...
        .route("/api/admin/stats/costs", get(handlers::admin_stats_handlers::get_cost_stats))
        .route("/api/admin/stats/usage", get(handlers::admin_stats_handlers::get_usage_stats))
