...
Do NOT add "Generated with Codex" or Co-Authored-By lines mentioning Codex/AI. Keep commit messages clean and focused on what changed.
...
For step-by-step guides, use skills in `.Codex/skills/`:
