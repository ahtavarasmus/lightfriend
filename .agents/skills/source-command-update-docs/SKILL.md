...
2. **Identify documentation that needs updating**
   ...
   - Check if changes affect **AGENTS.md** (development guide for AI assistants)
...
3. **Update documentation based on changes**
   ...
   **For backend changes:**
   - Update AGENTS.md if new patterns, integrations, or tools added
   ...
   **For frontend changes:**
   ...
   - Update AGENTS.md if new frontend pages or components added
   - Add entry to docs/CHANGELOG.md under appropriate category

   **For database changes:**
   - Update AGENTS.md if new tables or migration patterns introduced
...
4. **Create commit**
   ...
   - **Do NOT add "Generated with Codex" or Co-Authored-By lines** (per AGENTS.md guidelines)
...
## Important:
- Review git commits guide in AGENTS.md:82-85 (no AI attribution)
