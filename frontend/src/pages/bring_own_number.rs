...
#[function_component(TwilioInfoPart)]
pub fn twilio_info_part(props: &TwilioHostedInstructionsProps) -> Html {
...
#[function_component(TwilioSetupPart)]
pub fn twilio_setup_part(props: &TwilioHostedInstructionsProps) -> Html {
...
#[function_component(TwilioCredentialsPart)]
pub fn twilio_credentials_part(props: &TwilioHostedInstructionsProps) -> Html {
    let modal_visible = use_state(|| false);
    let selected_image = use_state(|| String::new());
