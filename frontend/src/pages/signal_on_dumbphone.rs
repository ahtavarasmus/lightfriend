        ...
        <div class="blog-page">
            ...
            <section class="blog-content">
                ...
                <div class="blog-cta">
                    ...
                    <a href="/get-started?platform=signal" data-fast-goal="blog_pricing_click" data-fast-goal-content-slug="signal-on-dumbphone" data-fast-goal-content-cluster="messaging">{"See how it works and start a trial"}</a>
                </div>
            </section>
            <style>
