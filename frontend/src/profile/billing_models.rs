...
pub struct UserProfile {
    ...
    pub byot_verification_status: Option<String>,
    pub byot_configured_at: Option<i32>,
    pub byot_verified_at: Option<i32>,
    pub byot_last_checked_at: Option<i32>,
    pub byot_error_code: Option<String>,
