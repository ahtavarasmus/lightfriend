        ...
        <div class="filter-section waiting-checks">
            ...
            <div class="filter-header">
                ...
                <div class="flow-description">
                    {"Get summarized updates about your messages at different times of the day"}
                </div>
                <div class="info-section" style={if *show_info { "display: block" } else { "display: none" }}>
                    <h4>{"How It Works"}</h4>
                    <div class="info-subsection">
                        <ul>
                            <li>{"Morning Digest: Get a summary of messages received overnight"}</li>
                            <li>{"Day Digest: Receive a midday update of important messages"}</li>
                            <li>{"Evening Digest: Review a summary of the day's communications"}</li>
                        </ul>
                    </div>
                </div>
            </div>
