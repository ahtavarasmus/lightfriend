...
print_tuwunel_purge_audit() {
    ...
    echo "server_census_policy enabled=${TUWUNEL_SERVER_CENSUS_PURGE_ENABLED:-true} scan_secs=${TUWUNEL_SERVER_CENSUS_SCAN_SECS:-21600} page_size=${TUWUNEL_SERVER_CENSUS_PAGE_SIZE:-5000} max_pages=${TUWUNEL_SERVER_CENSUS_MAX_PAGES:-10} http_timeout_secs=${TUWUNEL_SERVER_CENSUS_HTTP_TIMEOUT_SECS:-120} protected_admin_room=true"
